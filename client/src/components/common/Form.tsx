...
import { fontSize } from "@pankod/refine-mui";
  ...
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius='15px' padding='20px' bgcolor='#fcfcfc '>
        ...
        >
          <FormControl>
            <FormHelperText sx={{ fontWeight: 500, margin: '10px 0px', fontSize: 15, color: '#11142d' }}>
              Enter Property Name
            </FormHelperText>
            <TextField
              fullWidth
          ...
          <Stack direction="row" gap={4}>
            ...
            <FormControl sx={{ flex: 1 }}>
              ...
              >
                ...
                <MenuItem
                  value='farmhouse'>Farm House
                </MenuItem>
                <MenuItem
                  value='condos'>Condos
                </MenuItem>
                <MenuItem
                  value='townhouse'>Town House
                </MenuItem>
                <MenuItem
                  value='duplex'>Duplex
                </MenuItem>
          ...
          <Stack direction='column' gap={1} justifyContent='center' mb={2}>
            <Stack direction='row' gap={2} >
              ...
              <Button component='label' sx={{ width:
              'fit-content', color:"#2ed480" ,fontSize:16
              }}>
                Upload *
                <input
                  hidden
